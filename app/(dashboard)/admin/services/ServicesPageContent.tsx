...
import { getServicesPage, saveServicesPage } from '@/services/servicesPageService';
...
const ServicesPageContent = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const res = await saveServicesPage(formData);
            if (res.success) {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full mx-auto">
            <PageHeader
                description="Manage the SEO and Hero section of the main services page."
            ...
            <div className="bg-white p-8 mt-8 rounded-[2.5rem] shadow-sm border border-black/[0.03] mb-8">
                <div className="flex items-center gap-4 mb-8 pb-8 border-b border-black/[0.05]">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-black/40 font-medium">Configure the main banner of the services page</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                    ...
                    <div className="md:col-span-2">
                        <InputField
                            ...
                            placeholder="e.g. Expertise that drives growth"
                        />
                    </div>
                    <div className="md:col-span-2">
                        <InputField
