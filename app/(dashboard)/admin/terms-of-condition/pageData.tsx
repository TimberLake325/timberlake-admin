...
const TermsOfConditionPageData = ({ data, onChange }: { data: any, onChange: (newData: any) => void }) => {
    return (
        <div className="mt-4 space-y-6">
            <div className="p-8 bg-white border border-black/6 rounded-[2.5rem] shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <InputField
                        ...
                        placeholder="e.g. Legal agreements and usage policies"
                    />
                </div>
            </div>
            ...
            <div className="p-8 bg-white border border-black/6 rounded-[2.5rem] shadow-sm">
                <p className="text-[10px] font-black uppercase tracking-widest text-[#2563eb] mb-6 flex items-center gap-2">
                    <FiActivity size={14} /> Main Terms Content
                </p>
                <div className="min-h-[500px]">
                    <LexicalEditor
                        ...
                        placeholder="Write the terms and conditions body here..."
                    />
                </div>
            </div>
        </div>
...
export default TermsOfConditionPageData;